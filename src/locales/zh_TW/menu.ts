...
export const menu: SimpleTranslationEntries = {
  ...
  "passwordNotMatchingConfirmPassword": "密碼必須與確認密碼一致",
  "confirmPassword": "確認密碼",
  "registrationAgeWarning": "註冊表示您確認您已年滿13歲。",
  "backToLogin": "返回登入",
  "failedToLoadSaveData": "讀取存檔數據失敗。請重新載入頁面。如果\n問題仍然存在，請聯繫管理員。",
  "sessionSuccess": "工作階段載入成功.",
  "failedToLoadSession": "無法載入您的工作階段數據。它可能已損壞。",
  "boyOrGirl": "你是男孩還是女孩?",
  "boy": "男孩",
  "girl": "女孩",
  "evolving": "甚麼?\n{{pokemonName}} 要進化了!",
